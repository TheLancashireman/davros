...
*/
#ifndef DV_STM32_INTERRUPTS_H
#define DV_STM32_INTERRUPTS_H

#include "dv-devices.h"

/* This list is valid for the STM32F1xx low and medium density devices.
 * The XL devices can use the same list but some are shared.
 * Connectivity devices have extra a different list.
*/
enum dv_irqid_e
{
